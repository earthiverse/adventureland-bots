...
const targets: AL.MonsterName[] = ["rat"]

export async function startRatMageFarmer(bot: AL.Mage, friends: AL.Character[], merchant: string, holdPosition: IPosition): Promise<void> {
