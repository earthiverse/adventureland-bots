...
async function run() {
    ...
    console.log("----- points 13-1 -----")
    closestTo({ map: "winter_cove", x: 304, y: -1616 })
    closestTo({ map: "winter_cove", x: 256, y: -1535 })

    console.log("----- points 13-2 -----")
    closestTo({ map: "winter_cove", x: 208, y: -1518 })
    closestTo({ map: "winter_cove", x: 160, y: -1583 })
