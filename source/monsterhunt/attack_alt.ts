import AL, { Merchant, Priest, Ranger, Warrior, ServerInfoDataLive, IPosition, ServerRegion, ServerIdentifier } from "alclient"
import { goToAggroMonster, goToKiteMonster, goToNearestWalkableToMonster, goToSpecialMonster, MAIN_CHARACTERS, requestMagiportService, startTrackerLoop } from "../base/general.js"
...
import { startMerchant, startPriest, startRanger, startWarrior } from "./shared.js"

const TARGET_REGION: ServerRegion = "US"
const TARGET_IDENTIFIER: ServerIdentifier = "II"
const partyLeader = "attackRan"
const partyMembers = ["attackRan", "attackPri", "attackWar", ...MAIN_CHARACTERS]
