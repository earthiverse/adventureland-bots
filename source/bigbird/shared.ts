...
export async function startWarrior(bot: Warrior, merchant: string, friends: Character[], mainhand: ItemName, offhand: ItemName, location = mainBigBirds) {
    ...
    async function attackLoop() {
        try {
            ...
            // Idle strategy
            promises.push(attackTheseTypesWarrior(bot, ["bigbird", "scorpion", "spider"], friends, { disableStomp: true }))
...
export async function startPriest(bot: Priest, merchant: string, friends: Character[], location = mainBigBirds) {
    startShared(bot, merchant, friends)
    ...
    async function attackLoop() {
        try {
            ...
            // Idle strategy
            await attackTheseTypesPriest(bot, ["bigbird", "scorpion", "spider"], friends)
        } catch (e) {
            console.error(e)
        }
