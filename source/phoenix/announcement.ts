    ...
    const startMage1Loop = async (name: string, region: ServerRegion, identifier: ServerIdentifier) => {
        ...
        const loopBot = async () => {
            try {
                ...
                startPhoenixFarmer(information.bot1.bot as Mage, information.friends, information.merchant.name)
    ...
    const startMage2Loop = async (name: string, region: ServerRegion, identifier: ServerIdentifier) => {
        ...
        const loopBot = async () => {
            try {
                ...
                startPhoenixFarmer(information.bot2.bot as Mage, information.friends, information.merchant.name)
    ...
    const startMage3Loop = async (name: string, region: ServerRegion, identifier: ServerIdentifier) => {
        ...
        const loopBot = async () => {
            try {
                ...
                startPhoenixFarmer(information.bot3.bot as Mage, information.friends, information.merchant.name)
