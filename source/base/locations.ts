...
export const mainSpiders: AL.IPosition | ALM.IPosition = { map: "main", x: 948, y: -144 }

// Halloween
export const halloweenSafeSnakes: AL.IPosition | ALM.IPosition = { map: "halloween", x: 346.5, y: -747 }