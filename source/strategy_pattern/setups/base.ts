...
export function constructSetups(contexts: Strategist<PingCompensatedCharacter>[]): Setups {
    ...
    return {
        ...
        target_a500: constructGenericSetup(contexts, ["target_a500"], true),
        target_a750: constructGenericSetup(contexts, ["target_a750"], true),
        target_ar900: constructGenericSetup(contexts, ["target_ar900"], true),
        target_r500: constructGenericSetup(contexts, ["target_r500"], true),
        target_r750: constructGenericSetup(contexts, ["target_r750"], true),
        targetron: botsSetup,
