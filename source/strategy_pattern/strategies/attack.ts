...
export const IDLE_ATTACK_MONSTERS: MonsterName[] = ["arcticbee", "armadillo", "bat", "bee", "boar", "crab", "crabx", "croc", "cutebee", "frog", "goo", "hen", "iceroamer", "minimush", "nerfedbat", "osnake", "phoenix", "poisio", "rat", "rooster", "scorpion", "slenderman", "snake", "spider", "squig", "squigtoad", "tortoise", "wabbit"]
