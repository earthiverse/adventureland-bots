import AL, { ItemName, Merchant, PingCompensatedCharacter, TradeSlotType } from "alclient"
...
export class SellStrategy<Type extends PingCompensatedCharacter> implements SellStrategyOptions, Strategy<Type> {
