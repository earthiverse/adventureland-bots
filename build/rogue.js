...
class Rogue extends _character__WEBPACK_IMPORTED_MODULE_0__[/* Character */ "a"] {
    ...
    async quickStabLoop() {
        const targets = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getEntities */ "i"])({ isRIP: false, isMonster: true, isWithinDistance: parent.character.range * G.skills["quickstab"].range_multiplier });
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "n"])("quickstab") && targets.length) {
            if (targets[0].hp <= Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* calculateDamageRange */ "b"])(parent.character, targets[0])[0] * G.skills["quickstab"].damage_multiplier) {
                use_skill("quickstab", targets[0]);
                reduce_cooldown("quickstab", Math.min(...parent.pings));
            }
        }
        setTimeout(() => { this.quickStabLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("quickstab"));
    }
}
