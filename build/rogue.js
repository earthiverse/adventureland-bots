...
class Rogue extends _character__WEBPACK_IMPORTED_MODULE_0__[/* Character */ "a"] {
    constructor() {
        super();
        this.targetPriority = {
            "bee": {
        ...
        this.mainTarget = "goo";
        this.itemsToKeep.push("daggerofthedead");
    }
    async run() {
        await super.run();
        this.quickStabLoop();
    ...
    async quickStabLoop() {
        const targets = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getEntities */ "h"])({ isRIP: false, isMonster: true, isWithinDistance: parent.character.range * G.skills["quickstab"].range_multiplier });
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "m"])("quickstab") && targets.length) {
            if (targets[0].hp <= Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* calculateDamageRange */ "a"])(parent.character, targets[0])[0] * G.skills["quickstab"].damage_multiplier) {
                use_skill("quickstab", targets[0]);
                reduce_cooldown("quickstab", Math.min(...parent.pings));
            }
        }
        setTimeout(() => { this.quickStabLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "e"])("quickstab"));
    }
}
