...
class Mage extends _character__WEBPACK_IMPORTED_MODULE_0__[/* Character */ "a"] {
    ...
    cburstLoop() {
        try {
            ...
            if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "m"])("cburst") && targets.length) {
        ...
        setTimeout(() => { this.cburstLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "e"])("cburst"));
    }
    energizeLoop() {
        try {
            if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "m"])("energize")) {
                const partyMembers = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getEntities */ "h"])({ isPartyMember: true, isWithinDistance: G.skills["energize"].range, isRIP: false }).sort((a, b) => {
        ...
        setTimeout(() => { this.energizeLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "e"])("energize"));
    }
}
const mage = new Mage();
