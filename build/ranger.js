...
class Ranger extends _character__WEBPACK_IMPORTED_MODULE_0__[/* Character */ "a"] {
    constructor() {
        super();
        this.targetPriority = {
            "arcticbee": {
        ...
        this.itemsToKeep.push("bow", "bowofthedead", "crossbow", "cupid", "firebow", "hbow", "merry", "t2bow", "t3bow", "quiver", "t2quiver");
    }
    async run() {
        await super.run();
        this.superShotLoop();
