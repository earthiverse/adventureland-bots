...
/* harmony import */ var fastpriorityqueue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
/* harmony import */ var fastpriorityqueue__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(fastpriorityqueue__WEBPACK_IMPORTED_MODULE_3__);
...
const EASY = 30;
const SPECIAL = 500;
class Priest extends _character__WEBPACK_IMPORTED_MODULE_0__[/* Character */ "a"] {
    constructor() {
        super();
        this.targetPriority = {
            "arcticbee": {
        ...
        this.itemsToKeep.push("pmace", "mshield", "shield", "sshield", "xshield");
    }
    async mainLoop() {
        try {
    ...
    partyHealLoop() {
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "m"])("partyheal")) {
            for (const member of parent.party_list) {
                const e = parent.entities[member];
                if (!e)
                    continue;
        ...
        setTimeout(() => { this.partyHealLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "e"])("partyheal"));
    }
    darkBlessingLoop() {
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "m"])("darkblessing")) {
            let count = 0;
            for (const member of parent.party_list) {
                const e = parent.entities[member];
                if (!e)
        ...
        setTimeout(() => { this.darkBlessingLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "e"])("darkblessing"));
    }
    async attackLoop() {
        try {
            if (parent.character.c.town) {
            ...
            if (parent.character.hp < parent.character.max_hp - parent.character.attack * 0.9) {
                ...
                reduce_cooldown("attack", Math.min(...parent.pings));
                setTimeout(async () => { this.attackLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "e"])("attack", true));
                return;
            }
            const healTargets = new fastpriorityqueue__WEBPACK_IMPORTED_MODULE_3___default.a((x, y) => x.priority > y.priority);
            for (const member of parent.party_list || []) {
                ...
                if (entity
                    ...
                    healTargets.add({ id: member, priority: parent.character.max_hp / parent.character.hp });
                }
            }
            if (healTargets.size) {
