...
/* harmony import */ var fastpriorityqueue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3);
...
class Priest extends _character__WEBPACK_IMPORTED_MODULE_0__[/* Character */ "a"] {
    ...
    partyHealLoop() {
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "n"])("partyheal")) {
            for (const member of parent.party_list) {
                const e = parent.entities[member];
                if (!e)
                    continue;
        ...
        setTimeout(() => { this.partyHealLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("partyheal"));
    }
    darkBlessingLoop() {
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "n"])("darkblessing")) {
            let count = 0;
            for (const member of parent.party_list) {
                const e = parent.entities[member];
                if (!e)
        ...
        setTimeout(() => { this.darkBlessingLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("darkblessing"));
    }
    async attackLoop() {
        try {
            if (parent.character.c.town) {
            ...
            if (parent.character.hp < parent.character.max_hp - parent.character.attack * 0.9) {
                ...
                reduce_cooldown("attack", Math.min(...parent.pings));
                setTimeout(async () => { this.attackLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("attack", true));
                return;
            }
