...
class Warrior extends _character__WEBPACK_IMPORTED_MODULE_0__[/* Character */ "a"] {
    ...
    scareLoop() {
        try {
            const targets = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getEntities */ "i"])({ isAttackingUs: true, isRIP: false, isMonster: true });
            let wantToScare = false;
            if (targets.length >= 4) {
                wantToScare = true;
            }
                ...
                for (const target of targets) {
                    if (distance(target, parent.character) > target.range)
                        continue;
                    if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* calculateDamageRange */ "b"])(target, parent.character)[1] * 6 * target.frequency <= parent.character.hp)
                        continue;
                    wantToScare = true;
                    break;
                }
            }
            if (!Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "n"])("scare")
                || !wantToScare) {
                setTimeout(() => { this.scareLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("scare"));
                return;
            }
            if (parent.character.slots.orb.name == "jacko") {
                use_skill("scare");
                ...
                const items = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* findItems */ "d"])("jacko");
                if (items.length) {
                    const jackoI = items[0].index;
                    equip(jackoI);
                    use_skill("scare");
    ...
    agitateLoop() {
        try {
            if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "n"])("agitate")) {
                ...
                for (const id in parent.entities) {
                    ...
                    inAgitateCount++;
                    damage += Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* calculateDamageRange */ "b"])(e, parent.character)[1];
                }
        ...
        setTimeout(() => { this.agitateLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("agitate"));
    }
    warcryLoop() {
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "n"])("warcry")) {
            let count = 0;
            for (const member of parent.party_list) {
                const e = parent.entities[member];
                if (!e)
        ...
        setTimeout(() => { this.warcryLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("warcry"));
    }
    stompLoop() {
        const attackingTargets = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getEntities */ "i"])({ isAttackingUs: true, isRIP: false });
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "n"])("stomp") && attackingTargets.length) {
        ...
        setTimeout(() => { this.stompLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("stomp"));
    }
    cleaveLoop() {
        const wanted = [];
        const unwanted = [];
        for (const e of Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getEntities */ "i"])({ isMonster: true, isRIP: false, isWithinDistance: G.skills.cleave.range })) {
            if (parent.character.attack < Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* calculateDamageRange */ "b"])(parent.character, e)[0]) {
                unwanted.push(e);
                continue;
            }
            if (!this.targetPriority[e.mtype]) {
        ...
        for (const e of unwanted) {
            unwantedDamage += Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* calculateDamageRange */ "b"])(e, parent.character)[1];
        }
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "n"])("cleave") && wanted.length > 3 && unwantedDamage < 1000) {
            use_skill("cleave");
            reduce_cooldown("cleave", Math.min(...parent.pings));
        }
        setTimeout(() => { this.cleaveLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("cleave"));
    }
    chargeLoop() {
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "n"])("charge"))
            use_skill("charge");
        setTimeout(() => { this.chargeLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("charge"));
    }
    hardshellLoop() {
        const targets = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getEntities */ "i"])({ isAttackingUs: true, isRIP: false });
        if (Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* isAvailable */ "n"])("hardshell")
            && targets.length
            && distance(targets[0], parent.character) <= targets[0].range
            && parent.character.hp < Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* calculateDamageRange */ "b"])(targets[0], parent.character)[1] * 5) {
            use_skill("hardshell");
            reduce_cooldown("hardshell", Math.min(...parent.pings));
        }
        setTimeout(() => { this.hardshellLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("hardshell"));
    }
    async tauntLoop() {
        try {
            let incomingDamage = 0;
            const attackingUs = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getEntities */ "i"])({ isAttackingUs: true, isRIP: false, isMonster: true });
            for (const e of attackingUs) {
                incomingDamage += Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* calculateDamageRange */ "b"])(e, parent.character)[1];
            }
            if (incomingDamage < 1000 && attackingUs.length < 3) {
                const attackingParty = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getEntities */ "i"])({ isAttackingParty: true, isAttackingUs: false, isMonster: true, isRIP: false, isWithinDistance: G.skills.taunt.range });
                for (const e of attackingParty) {
                    if (!this.wantToAttack(e, "taunt"))
                        continue;
                    const damage = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* calculateDamageRange */ "b"])(e, parent.character)[1];
                    if (incomingDamage + damage > 1000)
                        continue;
                    await use_skill("taunt", e);
                    reduce_cooldown("taunt", Math.min(...parent.pings));
                    setTimeout(() => { this.tauntLoop(); }, Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getCooldownMS */ "f"])("taunt"));
                    return;
                }
                const notAttacking = Object(_functions__WEBPACK_IMPORTED_MODULE_2__[/* getEntities */ "i"])({ isAttackingParty: false, isMonster: true, isRIP: false, isWithinDistance: G.skills.taunt.range });
